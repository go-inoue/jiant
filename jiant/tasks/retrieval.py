...
TASK_DICT = {
    ...
    # CAMeLEGY
    "camel_egy_pos": CAMeLEGYposTask,
    "camel_egy_prc3": CAMeLEGYprc3Task,
    "camel_egy_prc2": CAMeLEGYprc2Task,
    "camel_egy_prc1": CAMeLEGYprc1Task,
    "camel_egy_prc0": CAMeLEGYprc0Task,
    "camel_egy_per": CAMeLEGYperTask,
    "camel_egy_asp": CAMeLEGYaspTask,
    "camel_egy_vox": CAMeLEGYvoxTask,
    "camel_egy_mod": CAMeLEGYmodTask,
    "camel_egy_form_gen": CAMeLEGYform_genTask,
    "camel_egy_form_num": CAMeLEGYform_numTask,
    "camel_egy_stt": CAMeLEGYsttTask,
    "camel_egy_cas": CAMeLEGYcasTask,
    "camel_egy_enc0": CAMeLEGYenc0Task,
    "camel_egy_enc1": CAMeLEGYenc1Task,
    "camel_egy_enc2": CAMeLEGYenc2Task,
    # CAMeLLEV
    "camel_lev_pos": CAMeLLEVposTask,
    "camel_lev_prc3": CAMeLLEVprc3Task,
    "camel_lev_prc2": CAMeLLEVprc2Task,
    "camel_lev_prc1": CAMeLLEVprc1Task,
    "camel_lev_prc0": CAMeLLEVprc0Task,
    "camel_lev_per": CAMeLLEVperTask,
    "camel_lev_asp": CAMeLLEVaspTask,
    "camel_lev_vox": CAMeLLEVvoxTask,
    "camel_lev_mod": CAMeLLEVmodTask,
    "camel_lev_form_gen": CAMeLLEVform_genTask,
    "camel_lev_form_num": CAMeLLEVform_numTask,
    "camel_lev_stt": CAMeLLEVsttTask,
    "camel_lev_cas": CAMeLLEVcasTask,
    "camel_lev_enc0": CAMeLLEVenc0Task,
    "camel_lev_enc1": CAMeLLEVenc1Task,
    "camel_lev_enc2": CAMeLLEVenc2Task,
}
