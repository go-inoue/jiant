...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        ...
        for token, pos in zip_equal(self.tokens, self.pos_list):
            ...
            labels += [CAMeLpos__per__form_gen__form_numTask.LABEL_TO_ID.get(pos, None)] + [None] * padding_length
...
class CAMeLpos__per__form_gen__form_numTask(Task):
    ...
    label_path = os.path.join(
        os.path.dirname(__file__), 'labels_pos__per__form_gen__form_num.txt'
    )
