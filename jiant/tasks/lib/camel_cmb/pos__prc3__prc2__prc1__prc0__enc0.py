...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        ...
        for token, pos in zip_equal(self.tokens, self.pos_list):
            ...
            labels += [CAMeLpos__prc3__prc2__prc1__prc0__enc0Task.LABEL_TO_ID.get(pos, None)] + [None] * padding_length
...
class CAMeLpos__prc3__prc2__prc1__prc0__enc0Task(Task):
    ...
    label_path = os.path.join(
        os.path.dirname(__file__), 'labels_pos__prc3__prc2__prc1__prc0__enc0.txt'
    )
