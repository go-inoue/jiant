...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        ...
        for token, pos in zip_equal(self.tokens, self.pos_list):
            ...
            labels += [CAMeLasp__mod__voxTask.LABEL_TO_ID.get(pos, None)] + [None] * padding_length
...
class CAMeLasp__mod__voxTask(Task):
    ...
    label_path = os.path.join(
        os.path.dirname(__file__), 'labels_asp__mod__vox.txt'
    )
