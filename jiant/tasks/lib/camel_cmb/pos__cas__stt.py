...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        ...
        for token, pos in zip_equal(self.tokens, self.pos_list):
            ...
            labels += [CAMeLpos__cas__sttTask.LABEL_TO_ID.get(pos, None)] + [None] * padding_length
...
class CAMeLpos__cas__sttTask(Task):
    ...
    label_path = os.path.join(
        os.path.dirname(__file__), 'labels_pos__cas__stt.txt'
    )
