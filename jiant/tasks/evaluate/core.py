...
def get_evaluation_scheme_for_task(task) -> BaseEvaluationScheme:
    ...
    if isinstance(
        ...
        (
            ...
            # CAMeLGLF
            tasks.CAMeLGLFposTask,
            tasks.CAMeLGLFprc3Task,
            tasks.CAMeLGLFprc2Task,
            tasks.CAMeLGLFprc1Task,
            tasks.CAMeLGLFprc0Task,
            tasks.CAMeLGLFperTask,
            tasks.CAMeLGLFaspTask,
            tasks.CAMeLGLFvoxTask,
            tasks.CAMeLGLFmodTask,
            tasks.CAMeLGLFform_genTask,
            tasks.CAMeLGLFform_numTask,
            tasks.CAMeLGLFsttTask,
            tasks.CAMeLGLFcasTask,
            tasks.CAMeLGLFenc0Task,
            tasks.CAMeLGLFenc1Task,
            tasks.CAMeLGLFenc2Task,
            # CAMeLEGY
            tasks.CAMeLEGYposTask,
            tasks.CAMeLEGYprc3Task,
            tasks.CAMeLEGYprc2Task,
            tasks.CAMeLEGYprc1Task,
            tasks.CAMeLEGYprc0Task,
            tasks.CAMeLEGYperTask,
            tasks.CAMeLEGYaspTask,
            tasks.CAMeLEGYvoxTask,
            tasks.CAMeLEGYmodTask,
            tasks.CAMeLEGYform_genTask,
            tasks.CAMeLEGYform_numTask,
            tasks.CAMeLEGYsttTask,
            tasks.CAMeLEGYcasTask,
            tasks.CAMeLEGYenc0Task,
            tasks.CAMeLEGYenc1Task,
            tasks.CAMeLEGYenc2Task,
            # CAMeLLEV
            tasks.CAMeLLEVposTask,
            tasks.CAMeLLEVprc3Task,
            tasks.CAMeLLEVprc2Task,
            tasks.CAMeLLEVprc1Task,
            tasks.CAMeLLEVprc0Task,
            tasks.CAMeLLEVperTask,
            tasks.CAMeLLEVaspTask,
            tasks.CAMeLLEVvoxTask,
            tasks.CAMeLLEVmodTask,
            tasks.CAMeLLEVform_genTask,
            tasks.CAMeLLEVform_numTask,
            tasks.CAMeLLEVsttTask,
            tasks.CAMeLLEVcasTask,
            tasks.CAMeLLEVenc0Task,
            tasks.CAMeLLEVenc1Task,
            tasks.CAMeLLEVenc2Task,
        ),
    ):
